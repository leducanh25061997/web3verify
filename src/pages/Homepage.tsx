    ...
    <div className='w-full min-h-screen bg-[#f5f7fa]'>
      <header className='background-radient-header'>
        <div className='flex justify-between py-6 container mx-auto'>
          ...
          <button onClick={() => open()} className="flex items-center gap-2 px-4 py-2 bg-white text-gray-800 rounded-full">
            <img
              src={METAMASK_ICON}
              alt='Metamask Icon'
              width={24}
            ...
            <div className='space-y-6'>
              <div className='bg-white rounded-xl shadow-md p-6'>
                ...
                <div id="walletNotConnected" className='flex flex-col justify-center items-center text-center py-8'>
                  ...
                  <button onClick={() => open()} className="font-medium flex justify-center items-center gap-2 px-4 py-2 bg-[#f3f4f6] text-gray-800 rounded-full w-full hover:bg-[#e5e7eb]">
                    <img
