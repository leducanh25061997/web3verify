import{i as N,a as k,x as a,r as L,e as v,H as p,d as O,R as Y,O as V,f as z,A as E,W}from"./index-DPI6dBkT.js";import{n as l,c as _,o as j,r as b}from"./if-defined-D4OIYKOq.js";import{T as A,D as F}from"./index-DTfotvuo.js";import"./index-D8VeAQiZ.js";import"./index-DMzDE0pP.js";import"./index-BWZ5f7if.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
